...
unless :integration in ExUnit.configuration[:exclude] do
  ...
  Hexpm.new_package("ecto", "0.2.1", [{:sample, "0.0.1", path: Case.fixture_path("sample")}, postgrex: "~> 0.2.1", ex_doc: "0.1.0"], pkg_meta, auth)
  ...
  Hexpm.new_package("depend_name", "0.2.0", [{:app_name, ">= 0.0.0", hex: :package_name}], pkg_meta, auth)
